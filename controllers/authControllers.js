...
class authControllers{
        ...
        try{
            ...
            if(admin){
                ...
                if(match){
                    ...
                    responseReturn(res,404,{error: "Salah Password"})
                }
    ...
    seller_register = async (req,res) => {
        ...
        try {
            ...
            if (getUser) {
                responseReturn(res,400,{error: 'Email Already Exis'})
            }else{
    ...
    change_password = async (req,res) => {
        ...
        try {
            ...
            if (!isMatch) return res.status(400).json({message: 'Incorrect old_password'});
